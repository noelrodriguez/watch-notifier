...
echo "  Flask      http://127.0.0.1:5000   (pid $FLASK_PID)   logs: webapp/flask/flask.log"
echo "  Streamlit  http://127.0.0.1:8501   (pid $STREAMLIT_PID)   logs: webapp/streamlit/streamlit.log"
echo ""
echo "To stop:"
echo "  kill $FLASK_PID        # Flask"
echo "  kill $STREAMLIT_PID    # Streamlit"
